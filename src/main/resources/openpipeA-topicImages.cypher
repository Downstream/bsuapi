...
// NATION
MATCH (a:Nation)<-[r:ART_NATION]-(x:Asset)
WITH a, r, x
SET r.representative =
(CASE WHEN x.name CONTAINS a.name THEN 10 ELSE 0 END)
...
MATCH (a:Nation)<-[r:ART_NATION]-(:Asset)
  WHERE r.representative > 0
WITH a, r ORDER BY r.representative DESC
WITH a, head(collect(r)) as prime
SET prime.prime = true
...
// CULTURE
MATCH (a:Culture)<-[r:ART_CULTURE]-(x:Asset)
WITH a, r, x
SET r.representative =
(CASE WHEN x.name CONTAINS a.name THEN 10 ELSE 0 END)
...
MATCH (a:Culture)<-[r:ART_CULTURE]-(:Asset)
  WHERE r.representative > 0
WITH a, r ORDER BY r.representative DESC
WITH a, head(collect(r)) as prime
SET prime.prime = true
...
// Classification
MATCH (a:Classification)<-[r:ART_CLASS]-(x:Asset)
WITH a, r, x
SET r.representative =
...
// set a searchable flag in the relationship
MATCH (a:Classification)<-[r:ART_CLASS]-(:Asset)
  WHERE r.representative > 0
WITH a, r ORDER BY r.representative DESC
WITH a, head(collect(r)) as prime
SET prime.prime = true
...
// Genre
MATCH (a:Genre)<-[r:ART_GENRE]-(x:Asset)
WITH a, r, x
SET r.representative =
(CASE WHEN trim(x.name) = a.name THEN 10 ELSE 0 END)
+ (CASE WHEN x.name CONTAINS a.name THEN 6 ELSE 0 END)
...
// set a searchable flag in the relationship
MATCH (a:Genre)<-[r:ART_GENRE]-(:Asset)
  WHERE r.representative > 0
WITH a, r ORDER BY r.representative DESC
WITH a, head(collect(r)) as prime
SET prime.prime = true
...
// Medium
MATCH (a:Medium)<-[r:ART_MEDIUM]-(x:Asset)
WITH a, r, x
SET r.representative =
(CASE WHEN trim(x.name) = a.name THEN 10 ELSE 0 END)
+ (CASE WHEN x.name CONTAINS a.name THEN 6 ELSE 0 END)
...
// set a searchable flag in the relationship
MATCH (a:Medium)<-[r:ART_MEDIUM]-(:Asset)
  WHERE r.representative > 0
WITH a, r ORDER BY r.representative DESC
WITH a, head(collect(r)) as prime
SET prime.prime = true
